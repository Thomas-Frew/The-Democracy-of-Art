...
$q = "SELECT first_name, last_name, reg_date, karma, artworks FROM tdoa_users ORDER BY karma DESC, artworks DESC";
...
if (mysqli_num_rows($r) != 0) {
	...
	// Leaderboard Users
	echo "<table><tr><th>Rank</th><th>Name</th><th class = 'extra_padding'>Karma</th><th class = 'extra_padding'>Artworks</th><th>Date Registered</th><tr>";
...
// Additional Options
echo "<p>You can also rank artists by <a href = 'tdoa_leaderboard_artworks.php'>artworks</a>.</p>";
